...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MyProductActionsJournal.ascx.cs" Inherits="SampleDictionaries.UserControls.MyProductActionsJournal" %>
...
<cc1:MyProductActionsJournalDataSource runat="server" ID="source" OnSelecting="Source_Selecting" AllowCustomCache=true />
...
<%
    ...
    {
%>
<cc1:MyProductActionsNavigatorControl ID="NavigatorControl" runat=server OnValuesInitialized="NavigatorControl_ValuesInitialized"/>
<%
    }
%>
<script>
            ...
            <BottomBar>
                <ext:PagingToolbar
                    ...
                    <Items>
                        ...
                        <NatC:HelpFileLinkExt runat="server" ID="btnHelp" WindowID="ModalWindow" NavigateUrlDefault="/HelpFiles/SampleDictionaries/MyProductActions.htm" NavigateUrl="/HelpFiles/SampleDictionaries/MyProductActions_Journal.htm" />
