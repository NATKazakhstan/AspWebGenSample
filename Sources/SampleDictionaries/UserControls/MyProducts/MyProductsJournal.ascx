...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MyProductsJournal.ascx.cs" Inherits="SampleDictionaries.UserControls.MyProductsJournal" %>
...
<cc1:MyProductsJournalDataSource runat="server" ID="source" OnSelecting="Source_Selecting" AllowCustomCache=true />
...
<%
    ...
    {
%>
<cc1:MyProductsNavigatorControl ID="NavigatorControl" runat=server OnValuesInitialized="NavigatorControl_ValuesInitialized"/>
<%
    }
%>
<script>
            ...
            <BottomBar>
                <ext:PagingToolbar
                    ...
                    <Items>
                        ...
                        <NatC:HelpFileLinkExt runat="server" ID="btnHelp" WindowID="ModalWindow" NavigateUrlDefault="/HelpFiles/SampleDictionaries/MyProducts.htm" NavigateUrl="/HelpFiles/SampleDictionaries/MyProducts_Journal.htm" />
