<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DIC_MyFirstDictionaryFilter.ascx.cs" Inherits="SampleDictionaries.UserControls.DIC_MyFirstDictionaryFilter" %>
